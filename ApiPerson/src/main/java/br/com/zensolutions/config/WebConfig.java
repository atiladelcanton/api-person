...
import br.com.zensolutions.serialization.converter.YamlJackson2HttpMessageConverter;

@Configuration
public class WebConfig implements WebMvcConfigurer {

	private static final MediaType MEDIA_TYPLE_APPLICATION_YML = MediaType.valueOf("application/x-yaml");
	...
	public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
		...
		configurer.favorParameter(false).ignoreAcceptHeader(false).useRegisteredExtensionsOnly(false)
				...
				.mediaType("xml", MediaType.APPLICATION_XML).mediaType("x-yaml", MEDIA_TYPLE_APPLICATION_YML);
	}
